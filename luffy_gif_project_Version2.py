...
# Download a Luffy GIF (replace this URL with your favorite Luffy GIF!)
...
for i, frame in enumerate(reader):
    ...
    # Example effect: Add text overlay
    ...
    # Example effect: Increase contrast for every 2nd frame
    if i % 2 == 1:
        enhancer = ImageEnhance.Contrast(pil_frame)
        pil_frame = enhancer.enhance(2.0)

    # Example effect: Add a red border
    border_size = 6
